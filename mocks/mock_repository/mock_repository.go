...
func (m *MockRepository) AddLink(link, shortlink string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddLink", link, shortlink)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddLink indicates an expected call of AddLink.
func (mr *MockRepositoryMockRecorder) AddLink(link, shortlink interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddLink", reflect.TypeOf((*MockRepository)(nil).AddLink), link, shortlink)
}
